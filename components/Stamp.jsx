    ...
    >
      <g transform="translate(-1,4) scale(7,7)">
        <g transform="translate(25,25) rotate(-30)  scale(0.3,0.3)">
          <polygon points="0,-60 -35,0 0,20 35,0" fill="none" stroke="#0087A3" strokeWidth="3px" />
          <polygon points="-35,0 0,20 35,0 0,-20" fill="none" stroke="#0087A3" strokeWidth="3px" />
          <polygon points="-35,10 0,60 35,10 0,30" fill="none" stroke="#0087A3" strokeWidth="3px" />
        </g>
        ...
        <path fill="none" d="M -2,25 A 27 27 0 1 0 -2,24.5 z" stroke="#0087A3" strokeWidth="1" />
      </g>
